...
// items.forEach(item => {
//     if (item.recipe == 1){
//         let index = items.findIndex(i => i.name == item.name.replace('recipe_', ''));
//         if (index != -1){
//             if (items[index].components == null){
//                 items[index].components = ['recipe']
//             } else {
//                 items[index].components.push('recipe');
//             }
...
//     let index = items.findIndex(item1 => item2.name.replace('item_', '') == item1.name)
//     if (index != -1){
//         items[index].recipe = item2.recipe;
//         items[index].cost = item2.cost;
//     } else {
//         console.log(item2.name.replace('item_', ''))
//     }
// });
